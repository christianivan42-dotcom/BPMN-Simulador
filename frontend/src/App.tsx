...
export function App() {
  ...
  // El arranque CREA la empresa por defecto si no existe, así que no puede
  // ejecutarse dos veces: en desarrollo React StrictMode invoca cada efecto por
  // duplicado y se creaban DOS organizaciones idénticas en la primera visita.
  ...
  async function bootstrap() {
    ...
    try {
      ...
      bootstrapped.current = false; // permite reintentar con el botón
      setAppState("error");
    }
  }
